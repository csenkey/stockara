...
- [ ] OHR-1/OHR-8: Restore Cognito JWT validation without the historical placeholder `X-User-Id` trust model.
...
- [ ] OHR-10: Add a private holding detail/review UI with generated-at versus evidence-as-of timestamps and progress polling.
